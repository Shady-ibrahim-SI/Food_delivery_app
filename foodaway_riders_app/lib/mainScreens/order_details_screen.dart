...
import 'package:foodaway_riders_app/widgets/shipment_address_design.dart';
import 'package:foodaway_riders_app/widgets/status_banner.dart';
                ...
                Container(
                  child: Column(
                    children: [
                      ...
                      Divider(thickness: 4,),
                      orderStatus == "ended" ? Image.asset('assets/images/success.jpg') : Image.asset('assets/images/confirm_pick.png'),
                      Divider(thickness: 4,),
