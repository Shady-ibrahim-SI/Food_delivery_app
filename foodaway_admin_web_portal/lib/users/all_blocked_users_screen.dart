...
class _AllBlockedUsersScreenState extends State<AllBlockedUsersScreen> {
  ...
  void initState() {
    ...
    super.initState();
    FirebaseFirestore.instance.collection("users").where("status",isEqualTo: "not approved")
  ...
  Widget build(BuildContext context) {
    Widget displayNotVerifiedUsersDesign(){
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      displayDialogBoxActivatingAccount(allUsers!.docs[index].id);
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("All Blocked Users Accounts",style: TextStyle(color: Colors.white),),
        centerTitle: true,
        ...
        body: Center(
          child: Container(
            ...
            child: displayNotVerifiedUsersDesign(),
          ),
        ),
      );
  }
