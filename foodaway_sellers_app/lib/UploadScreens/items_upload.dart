...
class ItemsUpload extends StatefulWidget {
  final Menus? model;
  ItemsUpload({super.key, this.model});
...
class _ItemsUploadState extends State<ItemsUpload> {
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed:() {
                takeImage(context);
              }, child: Text('Add New Items',style: TextStyle(color: Colors.white,fontSize: 18),),
              style: ButtonStyle(
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading: Icon(Icons.attach_money_outlined,color: Colors.cyan,),
            title: Container(
              width: 250,
              child: TextField(
  ...
  uploadImage(mImageFile) async{
    ...
    Reference reference =FirebaseStorage.instance.ref().child("items");
