...
import 'package:foodaway_sellers_app/assistantMethds/assistant_methods.dart';
import 'package:foodaway_sellers_app/widgets/order_card.dart';
...
Future<List<String>> separateOrderItemIDs(dynamic orderIDs)async{
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Center(child: Text("New Orders")),
        ...
        body: FutureBuilder(
          ...
          return StreamBuilder<QuerySnapshot>(
              ...
              .where("sellerUID",isEqualTo: uid).snapshots(), 
                ...
                return ListView.builder(
                  ...
                  itemBuilder:(context, index) {
                      ...
                      return FutureBuilder<List<String>>(
                        ...
                        .where("sellerUID",whereIn:  (orderSnapshot.data!.docs[index].data()! as Map<String , dynamic> )["Uid"])
